...
class SubjectsForGroupStudents extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $table
            ...
            ->addIndex(array('id_subject', 'id_group'), array('name' => 'idx_' . $this->tableName . '_subject_group'))
            ->addIndex(array('id_semester', 'id_group'), array('name' => 'idx_' . $this->tableName . '_semester_group'))
            ->addIndex(array('id_semester', 'id_subject'), array('name' => 'idx_' . $this->tableName . '_semester_subject'))
